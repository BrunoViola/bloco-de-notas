<div class="row mb-3 align-items-center">
    ...
    <div class="col text-center">
        Um projeto <span class="text-warning">Laravel</span> simples!
    </div>
    <div class="col">
        <div class="d-flex justify-content-end align-items-center">
            <span class="me-3"><i class="fa-solid fa-user-circle fa-lg text-secondary me-3"></i> {{ session('user.user_email') }} </span>
